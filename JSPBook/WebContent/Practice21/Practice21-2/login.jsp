<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <!-- method 지정하지 않음  -> get방식으로 전달
 아이디와 패스워드 창에 한글을 입력을 해도 깨지지 않는다.
 result.jsp 주소: http://localhost:8080/JSPBook/Practice21/Practice21-2/result.jsp?type=학부생&strID=한글&strPWd=한글
   -->
